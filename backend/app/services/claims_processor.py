...
from app.services.runtime_metadata import (
    ...
    get_db_partner_platform_activity,
...
# Metadata and availability functions moved to runtime_metadata.py
...
# is_partner_available_for_trigger moved to runtime_metadata.py
